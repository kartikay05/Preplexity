    ...
    return (
        <aside className="w-64 h-screen border-r border-white/10 bg-zinc-950/50 backdrop-blur-xl flex flex-col pt-6 pb-4">
             <div className="px-4 mb-8">
                    <span className="text-4xl font-medium text-zinc-300 group-hover:text-white">KRT AI</span>
            </div>
            ...
            <div className="mt-auto px-4 pt-4 border-t border-white/5">
                <div ref={dropdownRef} className="relative">
                    ...
                    >
                        ...
                        <svg className={`w-4 h-4 text-zinc-500 transition-transform ${showLogout ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {/* Dropdown Menu */}
                    {showLogout && (
                        <div className="absolute bottom-full left-0 right-0 mb-2 bg-zinc-900 border border-white/10 rounded-lg shadow-lg overflow-hidden z-50">
                            <button
                                onClick={() => {
                                    // Handle settings
                                    setShowLogout(false);
                                }}
                                className="w-full px-4 py-3 text-left text-sm text-zinc-300 hover:bg-zinc-800 hover:text-white transition-colors flex items-center gap-3 border-b border-white/5"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <button
                                ...
                                className="w-full px-4 py-3 text-left text-sm text-zinc-300 hover:bg-rose-600/20 hover:text-rose-400 transition-colors flex items-center gap-3"
                            >
                                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
