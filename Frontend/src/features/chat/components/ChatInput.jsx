...
import { sendMessage as apiSendMessage, fetchMessages } from '../service/chat.api';
import { addMessage, setCurrentChat, setLoading, setError, setMessages } from '../chat.slice';
            ...
            >
                ...
                <div className="flex items-center justify-between px-2 pt-1 pb-1">
                    <div className="flex gap-2">
                        <button type="button" className="p-2 text-zinc-500 hover:text-zinc-300 transition-colors rounded-lg hover:bg-white/5">
